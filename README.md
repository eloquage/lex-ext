...
Optional TypePHP native accelerator for [eloquage/lex](https://github.com/eloquage/lex).
...
```
php_eloquage_lex-X.Y.Z_php8.5-x86_64-Linux-glibc-N-debug-NTS.tar.gz
```

The archive contains `eloquage_lex.so`. Windows, macOS, ZTS, and non-8.5 binaries are not currently published.
